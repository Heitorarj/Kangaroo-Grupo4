...
public:
	sf::RectangleShape jogadorCorpo;
	Jogador() {
		jogadorCorpo.setFillColor(sf::Color::Green);
		jogadorCorpo.setSize(sf::Vector2f(30, 50));
		jogadorCorpo.setPosition(sf::Vector2f(150, 680));
	}
